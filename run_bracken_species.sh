...
OUT_TSV_DIR="/mnt/d/Bioinformatics/bracken_outputs_species"
OUT_W_DIR="/mnt/d/Bioinformatics/bracken_reports_species" # kreport-like outputs from Bracken
LOG_DIR="/mnt/d/Bioinformatics/bracken_logs_species"
# -----------------------
